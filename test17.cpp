...
{       
	...
	REQUIRE(findCourse[1].Section==02);
	REQUIRE(findCourse[2].Section==03);
	
	REQUIRE(findCourse[0].Title=="Program Design");
	REQUIRE(findCourse[1].Title=="Data Structure");
  REQUIRE(findCourse[2].Title=="Intro to CS");	
	
	REQUIRE(findCourse[0].Instructor=="Theys");
	REQUIRE(findCourse[1].Instructor=="Hummel");
	REQUIRE(findCourse[2].Instructor=="Kev");
