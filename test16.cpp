...
{       
	...
	Course bioC= ParseCourse("BIOE,103,03,Intro to Bioengineering 3,22,8,2,1,0,1,0,0,0,5,Hum");
	
	Course csA = ParseCourse("CS,101,01,Program Design,  22,8,2,1,0,0,0,0,0,5,Theys");
	Course csB = ParseCourse("CS,102,02,Data Structure,22,8,2,1,0,1,0,0,0,5,Hummel");
	Course csC = ParseCourse("CS,103,03,Intro to CS,22,8,2,1,0,1,0,0,0,5,Kev");
	...
	vector<Course> findCourse= FindCourses(bioDept,101);
	REQUIRE(findCourse.size()==1);
