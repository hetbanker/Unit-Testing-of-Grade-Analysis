...
{       
	...
	Course bioB= ParseCourse("BIOE,102,02,Intro to Bioengineering 2,0,0,0,0,0,0,100,1,0,5,Edd");
	...
	//Dept,Number,Section,Title,A,B,C,D,F,I,NR,S,U,W,Instructor
	vector<Course> findCourse= FindCourses(csDept,"Th");
	...
	REQUIRE(findCourse[1].Instructor=="Thummel");
}